...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  getStateProperty: (property) => ipcRenderer.invoke("get-state-property", property),
  setStateProperty: (property, value) => ipcRenderer.invoke("set-state-property", property, value),
