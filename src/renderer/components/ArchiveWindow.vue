  ...
  >
    ...
    >
      ...
      <template v-if="currentView === 'list'">
        ...
        <div class="p-4 border-b border-gray-200 dark:border-gray-700" style="-webkit-app-region: no-drag">
          <input 
            v-model="searchQuery"
            type="text"
        ...
        <div class="flex-1 flex flex-col overflow-hidden relative" style="-webkit-app-region: no-drag">
          ...
          <div class="flex-1 overflow-y-auto p-3">
            ...
            >
              <div class="flex-1 min-w-0">
                ...
                <div class="text-xs text-gray-600 dark:text-gray-400 mb-2">
                  {{ session.source }} • {{ formatDuration(session.duration) }} min
                </div>
            ...
            <div v-if="filteredSessions.length === 0" class="text-center py-10 px-5 text-gray-600 dark:text-gray-400">
              ...
              <p class="text-base font-medium text-gray-700 dark:text-gray-300 mb-2">No transcripts found</p>
              <p class="text-sm text-gray-500 dark:text-gray-400">Start recording to create your first transcript</p>
            </div>
          </div>
        </div>
      </template>
      <template v-if="currentView === 'detail' && selectedSession">
        <div class="flex-1 flex flex-col overflow-hidden relative">
          <div class="flex-1 flex flex-col p-5 overflow-hidden">
            ...
            <!-- Footer with stats -->
            <div class="px-0 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50/80 dark:bg-neutral-900/95 -mx-5 -mb-5 px-5">
